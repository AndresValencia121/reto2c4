...
import Reto2_Web.repositorio.AccessoryRepositorio;
...
public class AccessoryService {
     @Autowired
    private AccessoryRepositorio clotheRepository;
   ...
   public Optional<Accessory> getClothe(String reference) {
    ...
    public Accessory update(Accessory accesory) {
        ...
        if (accesory.getReference() != null) {
            Optional<Accessory> accesoryDb = clotheRepository.getClothe(accesory.getReference());
